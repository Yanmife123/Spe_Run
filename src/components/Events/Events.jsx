    ...
    <div className="event-container">
      ...
      <div className="events">
        ...
        <div className="event-right-side">
          ...
          <p>
            From workshops and seminars to site visits and networking sessions,
            our events cover a wide range of topics that cater to all levels of
            interest and expertise in petroleum engineering. Whether you're
            looking to enhance your skills, discover career opportunities, or
            simply stay updated on the latest trends in the energy sector,
          ...
          <p>
            ...
            Join us, attend our events, and take the first step towards building
            a successful career in petroleum engineering!
          </p>
          <p>
